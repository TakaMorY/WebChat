...
const _routes = [
  {
    name: "chat",
    path: "/chat",
    component: () => import('./chat-TMO07D8K.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-IJ-iytxu.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B-gpZlbJ.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "nonauth" } },
    component: () => import('./login-C-ApNK6K.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": "auth" },
    component: () => import('./profile-Du1di4tx.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": ["nonauth"] } },
    component: () => import('./register-C55-SETb.mjs')
  },
  {
    name: "debug-loading",
    path: "/debug-loading",
    component: () => import('./debug-loading-Cggo85N5.mjs')
  }
];
...
const useAuthStore = defineStore("roles", {
  state: () => ({
    user: null,
...
const namedMiddleware = {
  auth: () => import('./auth-CQu9YbPT.mjs'),
  nonauth: () => import('./nonauth-DJrNEx9r.mjs')
};
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-DRTFfcRM.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-C90URCxe.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DzL4H948.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-vJCVkqJJ.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRouter as b, useRuntimeConfig as c, defineNuxtRouteMiddleware as d, entry$1 as default, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, useAuthStore as u };
