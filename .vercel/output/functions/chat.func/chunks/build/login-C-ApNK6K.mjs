  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<span>Войти в аккаунт</span>`);
      }
      _push(`</button><div class="text-center"><p class="text-sm text-gray-600"> Еще нет аккаунта? `);
      ...
      _push(`</p></div></form></div><div class="text-center"><p class="text-xs text-gray-500"> Защищено современными технологиями шифрования </p></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=login-C-ApNK6K.mjs.map
